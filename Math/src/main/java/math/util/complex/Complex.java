...
public class Complex implements Cloneable {
	...
	private synchronized void  solveAbsAndArg()
	{
		abs = Math.sqrt(Math.pow(real, 2) + Math.pow(imag, 2));
		arg = Math.atan2(imag, real);
	}
	private synchronized void solveRealAndImag()
	{
	...
	public synchronized void setAbs(double abs)
	{
		this.abs = abs;
		solveRealAndImag();
	...
	public synchronized void setArg(double arg)
	{
	...
	public synchronized void setImag(double imag)
	{
		this.imag = imag;
		solveAbsAndArg();
	}
