...
import math.util.functions.NewtonZeroFinderD;
import math.util.functions.interfaces.OneVariableFunctionD;

public class PolynomialD implements OneVariableFunctionD{
	 ...
	 */
	public PolynomialD(double[] coefficients) {
		this.coefficients = coefficients;
	}
	/**
	 * @param r
	 * @return {@link PolynomialD}
	 * THIS WILL RETURN A NEW PolynomialD WITH THE 
	 * INPUT ADDED TO COEFFICIENT OF CONSTANT
	 */
	public PolynomialD add( double r)
	{
		...
		return new PolynomialD(coef);
	}
	/** 
	 * @param func
	 * @return
	 * THIS WILL RETURN A NEW PolynomialD AFTER ADDING THE INPUT 
	 * PolynomialD 
	 */
	public PolynomialD add(PolynomialD func)
	{
	 ...
	 */
	public PolynomialD subtract( double r)
	{
		return add( -r);
	}
	/**
	 * @param p
	 * @return
	 * THIS WILL RETURN A NEW PolynomialD AFTER SUBTRACTING
	 * THE INPUT PolynomialD 
	 */
	public PolynomialD subtract( PolynomialD p)
	{
	 ...
	 * MULTIPLIED BY INPUT
	 */
	public PolynomialD multiply( double r)
	{
		int n = this.coefficients.length;
		double coef[] = new double[n];
		for ( int i = 0; i < n; i++)
	 ...
	 */
	public PolynomialD divide( double r)
	{
	 ...
	 */
	public PolynomialD multiply( PolynomialD p)
	{
	 ...
	 */
	public PolynomialD integral( double value)
	{
	 ...
	 * POLYNOMIAL
	 */
	public PolynomialD divide( PolynomialD p)
	{
	 ...
	 * </pre>
	 */
	public PolynomialD[] divideWithRemainder( PolynomialD p)
	{
		PolynomialD[] answer = new PolynomialD[2];
		int m = degree();
		int n = p.degree();
		if ( m < n )
		{
			double[] q = {0};
			answer[0] = new PolynomialD( q);
			answer[1] = p;
			return answer;
		}
		...
		for ( int k = 0; k < n; k++)
			remainder[k] = coef[k];
		answer[0] = new PolynomialD( quotient);
		answer[1] = new PolynomialD( remainder);
		return answer;
	}
	/**
	 * @param p
	 ...
	 */
	public PolynomialD remainder( PolynomialD p)
	{
	 ...
	 */
	public PolynomialD deflate( double r)
	{
		int n = degree();
	...
	public double[] roots( double desiredPrecision) 
	{
		...
		PolynomialD p = this;
		NewtonZeroFinderD rootFinder =null;
			rootFinder= new NewtonZeroFinderD( this, dp, start);
